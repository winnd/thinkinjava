package ThinkingInJava4th源码code.TIJ4code.concurrency;//: concurrency/ListComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe List performance.
import java.util.concurrent.*;
import java.util.*;

import ThinkingInJava4th源码code.TIJ4code.containers.Tester;
  ...
  List<Integer> containerInitializer() {
    return Collections.synchronizedList(
      new ArrayList<Integer>(
        new net.mindview.util.CountingIntegerList(containerSize)));
  }
